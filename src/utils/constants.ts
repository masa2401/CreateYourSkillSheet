...
/**
 * ストレージキー定義。ユーザーデータやカテゴリ選択、アンケートデータの保存に使用されるキーを一元管理するためのオブジェクト。
 * これにより、ストレージキーの重複や誤用を防止し、コード全体で一貫したキーの使用が保証される。
 * 各キーは、ユーザーの名前、エンジニアカテゴリの選択状態、デザイナーカテゴリの選択状態、およびアンケートデータの保存に対応している。
 */
